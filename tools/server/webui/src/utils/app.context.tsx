    ...
    try {
      ...
      const params = {
        ...
        rag_connection: {
          ...
          user: getSelectedRagConnection(config).user,
          password: getSelectedRagConnection(config).password,
          host: getSelectedRagConnection(config).host,
          port: getSelectedRagConnection(config).port,
          name: getSelectedRagConnection(config).name,
        },
  ...
  return (
    <AppContext.Provider
      value={{
        ...
        canvasData,
        setCanvasData,
        config, // Pass config to context
        saveConfig, // Pass saveConfig to context
        showSettings,
        setShowSettings,
        serverProps,
      }}
